...
class DownloadsRepository @Inject constructor(
    ...
    companion object {
        ...
        // Supported file extensions for backup
        // Images
        private val IMAGE_EXTENSIONS = setOf("jpg", "jpeg", "png", "gif", "webp", "heic", "heif", "bmp", "tiff")
        // Videos
        private val VIDEO_EXTENSIONS = setOf("mp4", "3gp", "mkv", "avi", "mov", "webm", "flv", "wmv")
        // Documents
    ...
    suspend fun getAllMediaFiles(): List<MediaFile> = withContext(Dispatchers.IO) {
        ...
        android.util.Log.d("DownloadsRepository", "Scanning Downloads folder: ${downloadsDir.absolutePath}, exists=${downloadsDir.exists()}, isDir=${downloadsDir.isDirectory}")
        if (downloadsDir.exists() && downloadsDir.isDirectory) {
            scanDirectory(downloadsDir, mediaFiles)
        }

        android.util.Log.d("DownloadsRepository", "Found ${mediaFiles.size} files in Downloads folder")
